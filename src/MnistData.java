...
public class MnistData extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        //Change it to final to fix bug
        final ObservableList<XYChart.Series<Integer, Double>> answer = FXCollections.observableArrayList();
        ...
        final Button blearn2 = new Button();
        ...
        final TextField askNumNeurons = new TextField (); 
